...
<?php echo form_open('users/update/'.$user["id"]); ?>
	...
	<div class="form-group">
        ...
        <input type="text" class="form-control" name="pcode" placeholder="A1A 1A1" value="<?php echo $user['pcode']; ?>"/>
	...
	<div class="form-group">
        ...
        <input type="text" class="form-control" name="fax" placeholder="111-111-1111" value="<?php echo $user['fax']; ?>"/>
